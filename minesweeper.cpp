...
int click_x,click_y= 0,timeend=1;
int endGame=0;
    ...
    ui(new Ui::MineSweeper)
{
    ...
    runtime_Mine = new QTimer(this);
    connect(runtime_Mine,SIGNAL(timeout()),this,SLOT(on_secondadd()));
    connect(runtime_Mine,SIGNAL(timeout()),this,SLOT(update()));
}
...
void MineSweeper::paintEvent(QPaintEvent *event)
{
     ...
     //加载位图
     QPixmap mine_title(":/images/mine_title.bmp");
     QPixmap block_close(":/images/block_close.bmp");
     QPixmap block_open(":/images/block_open.bmp");
     QPixmap red_flag(":/images/redflag.bmp");
     QPixmap keil_boom(":/images/keilboom.bmp");
     QPixmap click_boom(":/images/clickboom.bmp");
     QPixmap boom(":/images/boom.bmp");
     QPixmap qq_smile(":/images/smile.bmp");
     QPixmap qq_lose(":/images/lose.bmp");
     QPixmap qq_pround(":/images/proud.bmp");
     QPixmap ele_0(":/images/ele0.bmp");
     QPixmap ele_1(":/images/ele1.bmp");
     QPixmap ele_2(":/images/ele2.bmp");
     QPixmap ele_3(":/images/ele3.bmp");
     QPixmap ele_4(":/images/ele4.bmp");
     QPixmap ele_5(":/images/ele5.bmp");
     QPixmap ele_6(":/images/ele6.bmp");
     QPixmap ele_7(":/images/ele7.bmp");
     QPixmap ele_8(":/images/ele8.bmp");
     QPixmap ele_9(":/images/ele9.bmp");
     QPixmap blk_1(":/images/blk1.bmp");
     QPixmap blk_2(":/images/blk2.bmp");
     QPixmap blk_3(":/images/blk3.bmp");
     QPixmap blk_4(":/images/blk4.bmp");
     QPixmap blk_5(":/images/blk5.bmp");
     QPixmap blk_6(":/images/blk6.bmp");
     QPixmap blk_7(":/images/blk7.bmp");
     QPixmap blk_8(":/images/blk8.bmp");
...
void painttitle(QPainter  * painter)
{
    ...
    QPixmap ele_8(":/images/ele8.bmp");
    QPixmap ele_9(":/images/ele9.bmp");
    QPixmap ele_10(":/images/ele10.bmp");
    QPixmap blk_1(":/images/blk1.bmp");
    QPixmap blk_2(":/images/blk2.bmp");
    QPixmap blk_3(":/images/blk3.bmp");
    QPixmap blk_4(":/images/blk4.bmp");
...
void MineSweeper::on_actionMiddle_triggered()
{
    endGame =0;
    timeend =1;
...
void MineSweeper::on_actionSenior_triggered()
{
    endGame =0;
    timeend =1;
...
void MineSweeper::on_actionQuit_triggered()
{
    QApplication::quit();
}

void MineSweeper::on_actionUser_defined_triggered()
{
...
void MineSweeper::closeEvent(QCloseEvent *event){
    endMine=true;
    mineSweeperProcess.kill_Process_APP(ana_ram);
    event->accept();
}
